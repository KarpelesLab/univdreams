...
impl LinuxAbi for I386Abi {
    ...
    fn map_syscall(&self, nr: u64) -> Option<Sysno> {
        Some(match nr {
            ...
            99 => Sysno::Statfs,
            100 => Sysno::Fstatfs,
            268 => Sysno::Statfs,  // statfs64
            269 => Sysno::Fstatfs, // fstatfs64
            39 => Sysno::Mkdir,
            40 => Sysno::Rmdir,
            41 => Sysno::Dup,
            55 => Sysno::Fcntl,
            ...
            302 => Sysno::Renameat,
            353 => Sysno::Renameat2,
            // chown family (16- and 32-bit variants) — ownership is a no-op.
            182 => Sysno::Chown,
            212 => Sysno::Chown, // chown32
            198 => Sysno::Chown, // lchown32
            207 => Sysno::Chown, // fchown32
            298 => Sysno::Chown, // fchownat
            83 => Sysno::Symlink,
            85 => Sysno::Readlink,
            92 => Sysno::Truncate,
            93 => Sysno::Ftruncate,
...
impl Amd64Abi {
    ...
    pub fn map(nr: u64) -> Option<Sysno> {
        Some(match nr {
            ...
            316 => Sysno::Renameat2,
            92 => Sysno::Chown,
            93 => Sysno::Chown,  // fchown
            94 => Sysno::Chown,  // lchown
            260 => Sysno::Chown, // fchownat
            271 => Sysno::Ppoll,
            280 => Sysno::Utimensat,
            292 => Sysno::Dup3,
            332 => Sysno::Statx,
            ...
            54 => Sysno::Setsockopt,
            55 => Sysno::Getsockopt,
            288 => Sysno::Accept,  // accept4
            165 => Sysno::Ignored, // mount — accept (we don't model mount points)
            166 => Sysno::Ignored, // umount2
            24 => Sysno::SchedYield,
...
impl Aarch64Abi {
    ...
    pub fn map(nr: u64) -> Option<Sysno> {
        Some(match nr {
            ...
            38 => Sysno::Renameat,
            276 => Sysno::Renameat2,
            54 => Sysno::Chown, // fchownat
            55 => Sysno::Chown, // fchown
            73 => Sysno::Ppoll,
            88 => Sysno::Utimensat,
            101 => Sysno::Nanosleep,
